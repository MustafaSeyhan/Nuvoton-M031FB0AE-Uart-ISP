...
#line 16 "..\\uart_transfer.c"





__attribute__((aligned(4))) uint8_t uart_rcvbuf[64] = {0};
...
void UART02_IRQHandler(void)
{
    ...
    uint32_t u32IntSrc = ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->INTSTS;

    if (u32IntSrc & 0x11)    
    {
        while (((((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFOSTS & (0x1ul << (14))) == 0) && (bufhead < 64))       
        {
            uart_rcvbuf[bufhead++] = ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->DAT;
        }
    }
...
void PutString(void)
{
    ...
    for (i = 0; i < 64; i++)
    {
        ...
        ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->DAT = response_buff[i];
    }
}
...
void UART_Init()
{
    ...
    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FUNCSEL = ((((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FUNCSEL & (~(0x7ul << (0)))) | ((0x0ul << (0))));
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->LINE = (3ul) | (0x0ul << (3)) | (0x0ul << (2));
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->FIFO = (0x3ul << (4)) | (0x3ul << (16));
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | (((((48000000UL)) + ((115200)/2ul)) / (115200))-2ul));
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->TOUT = (((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->TOUT & ~(0xfful << (0))) | (0x40);
    NVIC_SetPriority(UART02_IRQn, 2);
    NVIC_EnableIRQ(UART02_IRQn);
     
    ((UART_T *) ((( uint32_t)0x40000000) + 0x70000))->INTEN = ((0x1ul << (11)) | (0x1ul << (4)) | (0x1ul << (0)));
}
