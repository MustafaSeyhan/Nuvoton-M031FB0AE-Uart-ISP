...
int FMC_Proc(uint32_t u32Cmd, uint32_t addr_start, uint32_t addr_end, uint32_t *data)
{
    ...
    {
        ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPCMD = u32Cmd;
        ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPADDR = u32Addr;

        if (u32Cmd == 0x21UL)
        {
            ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPDAT = *data;
        }

        ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPTRG = 0x1;
        do { __schedule_barrier(); __isb(0xF); __schedule_barrier(); } while (0U);

        while (((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPTRG & 0x1) ;   

        Reg = ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPCTL;

        if (Reg & (0x1ul << (6)))
        {
            ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPCTL = Reg;
            return (-1);
        }

        if (u32Cmd == 0x00UL)
        {
            *data = ((FMC_T *) ((( uint32_t)0x40000000) + 0x0C000))->ISPDAT;
        }
